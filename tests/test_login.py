...
class TestLogin:
    ...
    @allure.title('Позитивный тест регистрации существующего пользователя')
    ...
    def test_existing_user_login(self, new_user):
        ...
        resp_delete = requests.delete(Constants.DELETE_USER_URL, headers={'Authorization': accessToken_1})
        print(resp_delete.status_code)


    @allure.title('Негативный  тест регистрации существующего пользователя')
